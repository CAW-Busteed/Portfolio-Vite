                            ...
                            {dropdownVisible && (
                                <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="absolute left-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white/70 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex={-1}>
                                    <div className="py-1" role="none">
                                        ...
                                        <a href="port-prog.html" className="text-gray-700 block px-4 py-2 text-sm  hover:bg-slate-200" role="menuitem" tabIndex={-1} id="menu-item-0">Programs</a>
                                        <a href="port-write.html" className="text-gray-700 block px-4 py-2 text-sm  hover:bg-slate-200" role="menuitem" tabIndex={-1} id="menu-item-1">Prose</a>
                                        <a href="port-sboards.html" className="text-gray-700 block px-4 py-2 text-sm  hover:bg-slate-200" role="menuitem" tabIndex={-1} id="menu-item-2">Storyboards</a>
                                        <a href="port-sustain.html" className="text-gray-700 block px-4 py-2 text-sm  hover:bg-slate-200" role="menuitem" tabIndex={-1} id="menu-item-3">Sustainability Projects</a>
                                    </div>
                                </div>
                            )}
                        </div>
